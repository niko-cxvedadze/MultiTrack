...
A full-stack, real-time SaaS application, built on a modern InstantDB + TypeScript monorepo boilerplate.

> This repository starts as a clean boilerplate: monorepo tooling, phone/email OTP auth, a customer-facing app shell, theming, i18n, and file uploads. Product features are built on top of this foundation.
